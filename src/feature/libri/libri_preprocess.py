...
def wav2feature(rootdir, mfcc_dir, label_dir, win_len=0.02, win_step=0.01, mode='mfcc', keyword='dev-clean', seq2seq=False):
  count = 0
...
if __name__ == '__main__':
  ...
  rootdir = '/media/pony/DLdigest/study/ASR/corpus/LibriSpeech/'+keyword
  wav2feature(rootdir, mfcc_dir, label_dir, win_len=0.02, win_step=0.01, mode='mfcc', keyword=keyword, seq2seq=True)
