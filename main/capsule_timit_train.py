...
flags.DEFINE_string('model', 'capsule', 'set the model to use, DBiRNN, BiRNN, ResNet..')
flags.DEFINE_string('rnncell', 'lstm', 'set the rnncell to use, rnn, gru, lstm...')
flags.DEFINE_integer('num_layer', 2, 'set the layers of capsules')
flags.DEFINE_integer('num_iter', 2, 'set the iteration for routing algorithm')
