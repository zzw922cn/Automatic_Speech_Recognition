...
def get_data(datadir, level, train_dataset, dev_dataset, test_dataset):
    train_feature_dirs = os.path.join(os.path.join(datadir, level, train_dataset), 
        os.listdir(os.path.join(datadir, level, train_dataset)), 'feature')

    train_label_dirs = os.path.join(os.path.join(datadir, level, train_dataset), 
        os.listdir(os.path.join(datadir, level, train_dataset)), 'label')

    dev_feature_dirs = os.path.join(os.path.join(datadir, level, dev_dataset), 
        os.listdir(os.path.join(datadir, level, dev_dataset)), 'feature')
    dev_label_dirs = os.path.join(os.path.join(datadir, level, dev_dataset), 
        os.listdir(os.path.join(datadir, level, dev_dataset)), 'label')

    test_feature_dirs = os.path.join(os.path.join(datadir, level, test_dataset), 
        os.listdir(os.path.join(datadir, level, test_dataset)), 'feature')

    test_label_dirs = os.path.join(os.path.join(datadir, level, test_dataset), 
        os.listdir(os.path.join(datadir, level, test_dataset)), 'label')

    return train_feature_dirs, train_label_dirs, dev_feature_dirs, dev_label_dirs,
            test_feature_dirs, test_label_dirs
...
class Runner(object):
    ...
    def load_data(self, mode, level):
        if mode == 'train':
            ...
            return load_batched_data(test_mfcc_dir, test_label_dir, batch_size, mode, level)
        else:
