...
flags.DEFINE_string('dataset', 'train-clean-100', 'set task name of this program')
...
train_mfcc_dir = os.path.join(datadir, level, dataset, 'feature')
train_label_dir = os.path.join(datadir, level, dataset, 'label')
test_mfcc_dir = os.path.join(datadir, level, dataset, 'feature')
test_label_dir = os.path.join(datadir, level, dataset, 'label')
